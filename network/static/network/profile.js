btn = document.querySelector('#follow_btn');
followers_count = document.querySelector('#followers_count');
visited_user_id = document.querySelector('h1').dataset.visited_id;
